header Kernel
  ...
  var
    ...
    threadManagerHoare: ThreadManagerHoare
...
---------------  ConditionHoare  ---------------
  ...
  class ConditionHoare
    ...
    methods
      Init ()
      Wait (mutex: ptr to MutexHoare)
      Signal (mutex: ptr to MutexHoare)
      Broadcast (mutex: ptr to Mutex)
  endClass
  ...
  class ThreadManagerHoare
    ...
    fields
      threadTable: array [MAX_NUMBER_OF_PROCESSES] of Thread
      freeList: List [Thread]
      aThreadBecameFree: ConditionHoare
      threadManagerLock: MutexHoare
  ...
  class FrameManager
    ...
    fields
      ...
      --numOfWaitingThreads: int 
      otherThreads: Condition
