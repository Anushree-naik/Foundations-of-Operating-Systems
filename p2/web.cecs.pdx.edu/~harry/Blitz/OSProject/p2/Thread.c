...
-----------------------------  TimerInterruptHandler  ---------------------------------
  ...
  function TimerInterruptHandler ()
    ...
    --
      currentInterruptStatus = DISABLED -- Disable interrupt
      currentThread.Yield ()    -- execute Yield fumction. suspendig time-slicing.
      currentInterruptStatus = ENABLED  -- Enable interrupt
    endFunction
